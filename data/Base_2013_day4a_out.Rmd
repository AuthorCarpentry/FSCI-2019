...
author:
- Principal Investigator - Your Name, `r params$institution`
...
Firstname Lastname, Principal Investigator, `r params$institution`
...
a. All original data, code, or reports produced as part of this project are owned by Trieste Polytechnic `r params$institution` per its institutional intellectual property policy.
...
_This will be auto-populated from your ORCID profile using the @R-rorcid `rorcid` package._
